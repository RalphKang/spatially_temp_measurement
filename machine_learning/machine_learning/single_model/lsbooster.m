function lsbooster(dir1,dir2,col,timelimit)
feat=load(dir1);
temp=load(dir2);
...
%% ensemble trees
model = fitrensemble(traindata,trainTargets(:,col),'Method','LSBoost',...
    'OptimizeHyperparameters',{'NumLearningCycles','MinLeafSize','MaxNumSplits','NumVariablesToSample','LearnRate'},...
...
output_name=strcat('col_',num2str(col),'.txt');
%fid = fopen('mse.txt','a');
